 ...
 */
@WebServlet("/bookClaimAdd")
public class bookClaimAdd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//if (result.equals("sucess")) {
			...
			ArrayList<Inventory> arrayOfInv1=seach_authenticator.getBookClaimTableObjectArray();
			...
			rd = request.getRequestDispatcher("bookClaimAddfromLib.jsp");
				...
				populate_list=false;
				//session.setAttribute("populate_list", populate_list);
				request.setAttribute("ErrorForDeptsearch2", " Book is not available with this dept name. ");
				rd = request.getRequestDispatcher("bookClaimAddfromLib.jsp");
			}
